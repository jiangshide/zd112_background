...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COMMENT='所属洲';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `zd_area_continent` VALUES (9,'亚洲','/static/upload/png/da597d355b2a0f80b5e9e7575aa73ef6_1512719096.png',1,0,1512719106,0);
...
CREATE TABLE `zd_tools_compress` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='文件压缩管理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `zd_tools_compress` VALUES (2,'sda','/static/upload/png/06b01ef7a60e7608704f395b731f096a_1512729661.png',0,'png','',152162,80014,1,0,1,0,1512729683,0,0);
...
INSERT INTO `zd_uc_admin` VALUES (1,'jiangshide','jiangshide','c233ae5551f2413b3a1249cf65ccb635','1','18311271399','dadsadsa',0,'18311271399@163.com','F8aUvXWk7H',1512778905,'127.0.0.1',0,0,0,1511493641,0),(16,'litian123','litian','84931bb6cf7ad6e282d3c2db4c465015','2,1','18311271399','',0,'18311271399@163.com','339xXAn87w',1511514804,'127.0.0.1',1,1,1,1511514783,1511514783);
...
CREATE TABLE `zd_uc_auth` (
  ...
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=78 DEFAULT CHARSET=utf8mb4 COMMENT='权限因子';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `zd_web_banner` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='焦点图管理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `zd_web_banner` VALUES (1,'活动1','http://www.baidu.com','/static/upload/jpg/b8c4d48a2430ee097da44820a8a12d4e_1512741286.jpg','this is the active1',0,1,0,1512618063,1512741294,0),(2,'活动2','http://www.baidu.com','/static/upload/jpg/63c8f234853bb992d47cb2a816e75249_1512741265.jpg','说三道四的',0,1,0,1512618080,1512741274,0),(3,'活动3','http://www.baidu.com','/static/upload/png/26a2a59bc884332c039d6328c2bfa489_1512741207.png','大大的',0,1,0,1512618098,1512741213,0),(4,'活动4','http://www.baidu.com','/static/upload/png/b0497fe6bc562a36ee8e28a67465094f_1512741174.png','是大大的',0,1,0,1512618134,1512741192,0),(5,'活动5','sdsdds','/static/upload/png/f5e07e4487c5baa061603378b2891d1d_1512741158.png','dsadsa',0,1,0,1512722719,1512741165,0);
...
-- Dump completed on 2017-12-10  8:00:56
